...
/**
 * Vendor implements the CRUD actions for Product model.
 */
class VendorController extends ActiveController
{
    public $modelClass = 'rest\versions\v1\models\Vendor';
...
/*    public function beforeAction($action)
    ...
    public function actionCreate()
    {
        ...
        if ($model->load($params, '') && $model->insertVendor()) {
